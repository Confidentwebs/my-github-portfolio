...
function RepoDetails() {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Confidentwebs/${id}`)
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Confidentwebs/${id}/branches`)
    .then((response) => (response.json()))
    .then((data) => {
      setBranch(data)
    })
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Confidentwebs/${id}/deployments`)
    .then((response) => (response.json()))
    .then((data) => {
      setDeployment(data)
    })
      ...
      <>
        ...
        <div id="repodetail">
            <div className="repodetail-card">
                ...
                <p>Live site: {deployment.length === 0 ? `none` : <a href={`https://Confidentwebs.github.io/${details.name}`}>Confidentwebs.github.io/{details.name}</a>}</p>
